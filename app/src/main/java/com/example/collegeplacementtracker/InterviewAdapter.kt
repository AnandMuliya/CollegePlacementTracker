...
class InterviewAdapter(
...
) : ListAdapter<InterviewAdapter.InterviewWithDetails, InterviewAdapter.InterviewViewHolder>(InterviewComparator()) {
    ...
    inner class InterviewViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val modeLocationTextView: TextView = itemView.findViewById(R.id.modeLocationTextView)
        ...
        fun bind(item: InterviewWithDetails) {
            ...
            modeLocationTextView.text = "${interview.interviewMode} - ${interview.interviewLocation}"
            ...
            statusBadge.backgroundTintList = ContextCompat.getColorStateList(itemView.context, badgeColor)
